...
Cusco is one of two mobile-first front end webs tempaltes included in this community beta release (the other being [Halifax](https://github.com/matrix-msu/mbira-halifax-template)).
...
To connect Cusco to your mbira installation, follow the instructions [here(https://github.com/matrix-msu/mbira-cusco-template/wiki).
